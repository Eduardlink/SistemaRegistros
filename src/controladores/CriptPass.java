...
public class CriptPass {
    private String llave = "LikinTech";
    /**
     * @param args the command line arguments
     */
   
    
    //Clave encriptacion-desencriptacion
    ...
    //Encriptar
    protected String Encriptar(String encriptar){
        try{
    ...
    //Desencriptar
        protected String Desencriptar(String desencriptar){
        try{
                SecretKeySpec secretKeySpec = CrearClave(llave);
                Cipher cipher =Cipher .getInstance("AES");
